...
inline HRESULT WINAPI WebAuthNPluginGetUserVerificationPublicKey(
    ...
    _Outptr_result_buffer_maybenull_(*pcbPublicKey) PBYTE* ppbPublicKey) // Free using WebAuthNPluginFreePublicKeyResponse
{
...
// This Credential Metadata Management API allows plugin authenticator to remove all credential
